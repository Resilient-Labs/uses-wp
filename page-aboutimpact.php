<?php
/**
 * Template Name: About/Impact Page
 *
 *
  ...
  ?>
    ...
    if ( $query->have_posts() ) {
        ...
        while ($query->have_posts()) {
            $query->the_post();
            if (has_tag('about-video-post')) {
              echo '<section class="video">';
              echo the_content();
              echo '</section>';
          }else if (has_tag('about-post')) {
                ...
                echo '</div>';
                echo '</section >';
            }else if (has_tag('about-infographic-post')) {
              echo '<section class="about-infographic">';
