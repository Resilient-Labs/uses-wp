    ...
    if ( $query->have_posts() ) {
        ...
        while ($query->have_posts()) {
            ...
            if (has_tag('volunteer-post')) {
                ...
                echo '</div>';
                echo '</section >';
            }else if (has_tag('volunteer-post-lincoln')) {
              echo '<section class ="flex-side">';
              echo '<div class="involved-container-out">';
              echo '<div class="involved-container-in">';
              echo '<div class= "involved-image">';
              $szPostContent = $post->post_content;
              $szSearchPattern = '~<img [^\>]*\ />~';
              ...
              echo '</div>';
              echo '<div class= "involoved-bottom">';
              echo only_content();
              echo '</div>';
              echo '</div>';
              echo '</div>';
